...
<template>
    <div class="card" style="padding: 1px; background-color: white; border: 0.64785px solid #EEEEEE;
            ...
            <div class="img-card">
                <img :src="firstImage" width="210px" height="120px" style="border-radius: 9.71774px 9.71774px 0px 0px;"/>
            </div>
            <div class="d-flex" style="flex-wrap: wrap; justify-content: space-between; margin: 8px;">
              <div class="d-flex">
                ...
                <div style="margin-left: 3px; margin-top: 5px; border-left : solid; color: #666666;  height : 12px;"></div>
